...
BlueWire Instascan works in [any browser that supports the WebRTC/getUserMedia API](http://caniuse.com/#feat=stream), which currently includes Chome, Safari, Firefox, Opera, and Edge. IE is not supported.
...
Reworked by [Chris Schmich](https://github.com/schmich/instascan)

Modified by [BlueWire](https://github.com/bluewire-team/bluewire-instascan)

## License

Copyright &copy; 2021 [GrapsZ](https://github.com/GrapsZ) for BlueWire
